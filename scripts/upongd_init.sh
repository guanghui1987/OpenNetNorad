...
RACK="MY_PONG_RACK"
REGISTER_START="/usr/bin/wget -O - --post-data=xkey=c79c2a46728d469487b9670c42d9f87e&region=$REGION&cluster=$CLUSTER&rack=$RACK http://$LOG_SERVER:5000/v1/servers/create"
REGISTER_STOP="/usr/bin/wget -O - --post-data=xkey=c79c2a46728d469487b9670c42d9f87e&is_active=0 http://$LOG_SERVER:5000/v1/servers/update"
