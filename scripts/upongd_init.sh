...
RACK="MY_PONG_RACK"
REGISTER_START="/usr/bin/wget -O - --post-data=region=$REGION&cluster=$CLUSTER&rack=$RACK http://$LOG_SERVER:5000/v1/servers/create"
REGISTER_STOP="/usr/bin/wget -O - --post-data=is_active=0 http://$LOG_SERVER:5000/v1/servers/update"
